...
userService.hasEmail = function(p0, callback) {
	dwr.engine._execute(userService._path, 'userService', 'hasEmail', p0,
			callback);
}
userService.signIn = function(p0, p1, p2, callback) {
	dwr.engine._execute(userService._path, 'userService', 'signIn', p0, p1, p2,
			callback);
}
